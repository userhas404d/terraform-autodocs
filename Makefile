...
guard/tfdocs-awk:
	mkdir -p scripts
	$(CURL) -o scripts/terraform-docs.awk https://raw.githubusercontent.com/plus3it/tfdocs-awk/master/terraform-docs.awk
	$(CURL) -o scripts/terraform-docs.sh https://raw.githubusercontent.com/plus3it/tfdocs-awk/master/terraform-docs.sh
	$(CURL) -o scripts/autodocs.sh https://raw.githubusercontent.com/plus3it/tfdocs-awk/master/autodocs.sh
	chmod -R 755 scripts/*

docs/generate: guard/program/terraform-docs guard/tfdocs-awk
	@ echo "[$@]: Creating documentation files.."
	@ bash ./scripts/autodocs.sh -g
	@ echo "[$@]: Documentation generated!"

docs/lint: guard/program/terraform-docs guard/tfdocs-awk
	@ echo "[$@] Linting documentation files.."
	@ bash ./scripts/autodocs.sh -l
